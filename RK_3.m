...
figure(1)
subplot(1,3,1)
plot(t,uex,t(1:i1),u2,'LineWidth',1.5)
grid on;
legend('Soluzione esplicita', 'RK2','LineWidth',1.5)
subplot(1,3,2)
plot(t(1:i1),abs(uex(1:i1)-u2(1:i1)),'LineWidth',1.5)
grid on;
legend('Errore assoluto','LineWidth',1.5)
subplot(1,3,3)
semilogy(t(1:i1),abs(uex(1:i1)-u2(1:i1))./u2(1:i1),'LineWidth',1.5)
grid on;
...
figure(2)
subplot(1,3,1)
plot(t,uex,t(1:i2),u3,'LineWidth',1.5)
grid on;
legend('Soluzione esplicita', 'RK3','LineWidth',1.5)
subplot(1,3,2)
plot(t(1:i2),abs(uex(1:i2)-u3(1:i2)),'LineWidth',1.5)
grid on;
legend('Errore assoluto','LineWidth',1.5)
subplot(1,3,3)
semilogy(t(1:i2),abs(uex(1:i2)-u3(1:i2))./u3(1:i2),'LineWidth',1.5)
grid on;
legend('Errore relativo','LineWidth',1.5)
...
figure(3)
subplot(1,3,1)
plot(t,uex,t(1:i3),u3,'LineWidth',1.5)
grid on;
legend('Soluzione esplicita', 'RK4','LineWidth',1.5)
subplot(1,3,2)
plot(t(1:i3),abs(uex(1:i3)-u3(1:i3)),'LineWidth',1.5)
grid on;
legend('Errore assoluto','LineWidth',1.5)
subplot(1,3,3)
semilogy(t(1:i3),abs(uex(1:i3)-u3(1:i3))./u3(1:i3),'LineWidth',1.5)
grid on;
legend('Errore relativo','LineWidth',1.5)
